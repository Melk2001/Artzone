  $(document).ready(function(){
    ...
    if (localStorage.getItem('userdetails') === null) {  
        ...
        var userDetails = {firstName:"Joe", lastName:"Bloggs", dob:"1990-12-01",address1:"Main St.", address2:"", address3:"Co. Sligo"};
    ...
    $('form[name="login"]' ).submit(function( event ) {
        ...
        if (email=="joeblogg@myemail.com" && password=="password1")  {   
...
function alert()
{
    alert('thank you for you enquiry we hope to get back to you as soon as possible');
    
    let alert = document.getElementById("btn");
}